  ...
  return (
    <div className="bgHero">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-start lg:gap-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            <div className="col-span-2">
              <div>
                <h2 className="text-2xl font-bold text-[#C7B365]">
                  Get the latest news!
                </h2>
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-[#C7B365]">Services</p>
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-[#C7B365]">Company</p>
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-[#C7B365]">Helpful Links</p>
            ...
            <ul className="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end">
              <li>
                <Link
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-[#C7B365] transition hover:opacity-75"
                >
        ...
        <div className="mt-8 border-t border-[#C7B365] pt-8">
          <div className="sm:flex sm:justify-between">
            <p className="text-xs text-white">
              &copy; 2022. Bati B Designs. All rights reserved.
            </p>
