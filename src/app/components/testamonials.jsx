        ...
        <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <div className="md:flex md:items-end md:justify-between">
            <div className="max-w-xl">
              <h2 className="text-4xl font-bold tracking-tight text-[#C7B365] sm:text-5xl">
                Read trusted reviews from our customers
              </h2>
              <p className="mt-6 max-w-lg leading-relaxed text-gray-700">
                At Bati B Designs, our proudest moments come from the success
                stories and satisfied smiles of our clients. Their experiences,
                shared in their own words below, illuminate our unwavering
                commitment to excellence in every service we provide. Dive in
                and discover the difference we've made in spaces and lives, just
                like yours.
              </p>
            </div>
